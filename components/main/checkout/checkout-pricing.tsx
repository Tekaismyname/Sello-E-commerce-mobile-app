...
export function CheckoutPricing({ subtotal, shippingFee, discount, totalAmount }: CheckoutPricingProps) {
  return (
    <View className="rounded-[16px] bg-white p-4">
      <Text className="text-[15px] font-extrabold text-[#1F2934]">Chi tiết thanh toán</Text>

      <View className="mt-3 gap-2">
        <View className="flex-row items-center justify-between">
          <Text className="text-[13px] text-[#5E6A78]">Tạm tính</Text>
          <Text className="text-[13px] font-semibold text-[#1F2934]">{formatPrice(subtotal)}</Text>
        </View>
        <View className="flex-row items-center justify-between">
          <Text className="text-[13px] text-[#5E6A78]">Phí vận chuyển</Text>
          <Text className="text-[13px] font-semibold text-[#1F2934]">{formatPrice(shippingFee)}</Text>
        </View>
        <View className="flex-row items-center justify-between">
          <Text className="text-[13px] text-[#5E6A78]">Giảm giá</Text>
      ...
      <View className="flex-row items-center justify-between">
        <Text className="text-[15px] font-extrabold text-[#1F2934]">Tổng cộng</Text>
