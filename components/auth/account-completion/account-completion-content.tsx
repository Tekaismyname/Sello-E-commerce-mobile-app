      ...
      <KeyboardAvoidingView className="flex-1" behavior={Platform.OS === "ios" ? "padding" : undefined}>
        <ScrollView className="flex-1" contentContainerClassName="px-6 pb-10 pt-8" showsVerticalScrollIndicator={false}>
          <View className="items-center">
            ...
            <Text className="mt-8 text-center text-[36px] font-extrabold leading-[42px] text-[#111827]">Hoan thien thong tin</Text>
            <Text className="mt-3 text-center text-[16px] leading-[24px] text-[#4B5563]">Bo sung thong tin de dat hang nhanh hon va bao mat tai khoan.</Text>
          </View>

          <View className="mt-8 rounded-[16px] bg-white p-4">
            <Text className="text-[14px] font-bold text-[#111827]">So dien thoai</Text>
            ...
            <Text className="mt-4 text-[14px] font-bold text-[#111827]">Ngay sinh (ISO hoac DD/MM/YYYY)</Text>
            <View className="mt-2 h-[52px] flex-row items-center rounded-[12px] bg-[#F3F5FA] px-4">
            ...
            <Text className="mt-4 text-[14px] font-bold text-[#111827]">Dia chi giao hang</Text>
            <View className="mt-2 min-h-[90px] rounded-[12px] bg-[#F3F5FA] px-4 py-3">
              <TextInput className="text-[16px] text-[#111827]" placeholder="So nha, ten duong, phuong/xa..." value={address} onChangeText={setAddress} multiline />
            </View>

            <Text className="mt-4 text-[14px] font-bold text-[#111827]">Gioi tinh</Text>
            ...
            <View className="mt-4 flex-row items-center justify-between rounded-[12px] bg-[#F8FAFC] px-3 py-3">
              <View className="flex-row items-center gap-2">
                ...
                <Text className="text-[14px] font-semibold text-[#111827]">Nhan uu dai qua Email</Text>
              </View>
          ...
          <AuthButton title="Hoan tat" loading={loading} className="mt-4" onPress={submit} />
          <Pressable className="mt-2 h-[48px] items-center justify-center" onPress={skip}>
            <Text className="text-[14px] font-semibold text-[#6B7280]">Bo qua</Text>
          </Pressable>
        </ScrollView>
