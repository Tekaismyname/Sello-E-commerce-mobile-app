...
export function ProductSpecs({
  ...
  return (
    <View className="mb-6 rounded-[16px] border border-[#F2F3F7] bg-white p-5 shadow-sm">
      <Text className="mb-5 text-[16px] font-bold text-[#191C1F]">Technical Specs</Text>
      ...
      <View className="gap-4">
        ...
        <View>
          <Text className="mb-2 text-[11px] font-bold uppercase text-[#6B7682]">WARRANTY (MONTHS)</Text>
          <TextInput
            className="h-12 rounded-[12px] border border-[#E7E8EC] bg-[#F4F5F7] px-4 text-[14px] text-[#191C1F]"
            placeholder="VD: 12"
            placeholderTextColor="#97A0AB"
