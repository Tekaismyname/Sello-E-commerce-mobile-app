...
export function AdminNotificationComposer({ loading, onSubmit }: Props) {
  ...
  return (
    <View className="rounded-[16px] bg-white p-4">
      <Text className="text-[22px] font-extrabold text-[#111827]">Create New Notification</Text>
      <Text className="mt-1 text-[13px] text-[#6B7280]">Draft and send push notifications to app users.</Text>

      <Text className="mt-4 text-[14px] font-bold text-[#111827]">Title</Text>
      <TextInput className="mt-2 h-12 rounded-[12px] bg-[#F3F5FA] px-3" value={title} onChangeText={setTitle} placeholder="E.g: Weekend Promo" />

      <Text className="mt-4 text-[14px] font-bold text-[#111827]">Content</Text>
      <TextInput className="mt-2 min-h-[110px] rounded-[12px] bg-[#F3F5FA] px-3 py-3" multiline value={content} onChangeText={setContent} placeholder="Enter notification content..." />

      <Text className="mt-4 text-[14px] font-bold text-[#111827]">Recipients</Text>
      ...
      <Text className="mt-4 text-[14px] font-bold text-[#111827]">Notification Type</Text>
      ...
      <Text className="mt-4 text-[14px] font-bold text-[#111827]">Attached Image URL (optional)</Text>
      ...
      <View className="mt-4 flex-row items-center justify-between rounded-[12px] bg-[#F8FAFC] px-3 py-3">
        <Text className="text-[14px] font-semibold text-[#111827]">Send Now</Text>
