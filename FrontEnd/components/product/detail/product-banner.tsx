    ...
    <View className="bg-white px-4 py-5">
      <View className="h-[200px] w-full overflow-hidden rounded-[12px]">
        ...
        <View className="absolute bottom-0 left-0 right-0 bg-black/40 p-5">
          <Text className="text-[24px] font-extrabold text-white">Vượt Qua Mọi Giới Hạn</Text>
          <Text className="mt-1 text-[13px] text-white/80">Phong cách đường phố biểu tượng mọi thời đại.</Text>
        </View>
      </View>
    </View>
  );
